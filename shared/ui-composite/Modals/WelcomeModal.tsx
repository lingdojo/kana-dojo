      ...
      case 'themes':
        return (
          <div className='space-y-6'>
            ...
            <div className='scrollbar-thin scrollbar-thumb-(--border-color) scrollbar-track-transparent space-y-6 px-1'>
              {themeSets
                .filter(
                  themeSet =>
                    themeSet.name === 'Base' ||
      ...
      case 'fonts':
        return (
          <div className='space-y-6'>
            ...
            <div className='scrollbar-thin scrollbar-thumb-(--border-color) scrollbar-track-transparent space-y-6 p-1 pr-2'>
              <CollapsibleSection
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div
            ref={contentRef}
            className='min-h-0 flex-1 overflow-y-auto p-2 pb-2 sm:p-5'
          >
