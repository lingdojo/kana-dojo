...
| Week | Focus                | Goal                        |
| ---- | -------------------- | --------------------------- |
| 1    | Vowels + K, S rows   | Recognize 15 characters     |
| 2    | T, N, H rows         | Recognize 30 characters     |
| 3    | M, Y, R, W rows + ん | Recognize all 46 characters |
| 4    | Dakuten & Handakuten | Master all variations       |
